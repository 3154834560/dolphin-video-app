package com.example.dolphin.activity.tools.translate;
...
public class TranslateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String appId = "20221121001463827";//APP ID 来源于百度翻译平台
    private String key = "Cau7hCEHBjGIE5y6TJ5j";//秘钥 来源于百度翻译平台
